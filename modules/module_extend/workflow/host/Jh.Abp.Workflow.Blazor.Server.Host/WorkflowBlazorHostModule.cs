...
using Jh.Abp.Workflow.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(WorkflowBlazorServerModule)
)]
public class WorkflowBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(WorkflowDomainModule).Assembly,
                typeof(WorkflowDomainSharedModule).Assembly,
                typeof(WorkflowApplicationModule).Assembly,
                typeof(WorkflowApplicationContractsModule).Assembly,
                typeof(WorkflowBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Jh.Abp.Workflow.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<WorkflowBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(WorkflowBlazorHostModule).Assembly;
        });
