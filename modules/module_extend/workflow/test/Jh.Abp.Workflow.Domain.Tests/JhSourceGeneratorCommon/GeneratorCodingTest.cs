...
namespace Jh.Abp.Workflow
{
    public class GeneratorCodingTest
    {
        ...
        public void TestGetTableClass()
        {
            ...
            var domainAssembly = typeof(WorkflowDomainModule).Assembly;
            var itemName = "Jh.Abp.Workflow";
            var domain = @"\Workflow";
            var options = new GeneratorOptions()
            {
                DbContext = "WorkflowDbContext",
                Namespace = "Jh.Abp.Workflow",
                ControllerBase = "WorkflowController",
            ...
            var mapTables = new Type[] { typeof(WorkflowBacklog),typeof(WorkflowDefinition),typeof(WorkflowInstance) };
