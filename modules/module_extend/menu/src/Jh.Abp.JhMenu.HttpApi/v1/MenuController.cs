...
namespace Jh.Abp.JhMenu.v1
{
	...
	public class MenuController : JhMenuController
	{
		...
		[Authorize(JhAbpJhMenuPermissions.Menus.BatchCreate)]
		[Route("items")]
		[HttpPost]
		public virtual async Task CreateAsync(MenuCreateInputDto[] input)
		{
		...
		[HttpDelete]
		public virtual async Task DeleteAsync(MenuDeleteInputDto deleteInputDto)
		{
