...
using Jh.Abp.JhMenu.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(JhMenuBlazorServerModule)
)]
public class JhMenuBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(JhMenuDomainModule).Assembly,
                typeof(JhMenuDomainSharedModule).Assembly,
                typeof(JhMenuApplicationModule).Assembly,
                typeof(JhMenuApplicationContractsModule).Assembly,
                typeof(JhMenuBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Jh.Abp.JhMenu.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<JhMenuBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(JhMenuBlazorHostModule).Assembly;
        });
