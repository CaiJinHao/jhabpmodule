    ...
    public class GeneratorService
    {
        ...
        public virtual void GeneratorCodeByTsx(string moduleNamespace, IEnumerable<Type> domainTypes,string jhModuleName)
        {
            foreach (var item in domainTypes)
            {
                ...
                CreateFile(new ReactAntdEditCodeBuilder(item, generatorOptions.CreateProxyServicePath, moduleNamespace, jhModuleName, GetTableDescription(item), generatorType));
            }
        }
