	...
	42: function(e, t, n) {
		...
		function k(e, t, n, o, r, i, a, l, s, c) {
			var f, d, m, x, g, _, w, k = o && o.__k || p,
				C = k.length;
			for (s == u && (s = null != a ? a[0] : C ? v(o, 0) : null), n.__k = [], f = 0; f < t.length; f++)
		...
		function P(e, t, n, o, r, i, a, l) {
			var s, c, f, d, h, m = n.props,
				b = t.props;
			if (r = "svg" === t.type || r, null != i) for (s = 0; s < i.length; s++)
					...
					value: function(e) {
						...
						if (e.paging) {
							...
							var V = {
								...
								F = {},
								U = {};
							T <= 1 && (F = V), T == M && (U = V), this.state.pageIndex !== T && this.changePageIndex(T), this.size = M, D = m("div", {
								class: "xm-paging"
							}, m("span", {
								style: F,
					...
					value: function(e, t, n, o) {
						...
						if (!this.checkMax(c, c, !0)) {
							if (l.show && l.strict || s.show && s.strict) {
								...
								this.clearAndReset(u, c, !1), c = this.init({
									data: u,
									prop: a
								}, !0)
							}
							this.resetSelectValue(c, o || c, r, n), this.setState({
								show: t
							})
						}
					}
					...
					value: function(e, t, n, o) {
						...
						if (!n) {
							if (e[m] && (c.show && c.strict || u.show && u.strict)) {
								...
								f = Se(this.state.sels), y = [], this.treeHandler(f, e, y, b, !0), this.resetSelectValue(f, y, x), this.setState({
