...
export const  getCountIdentityUserLookup = async (input: UserLookupCountInputDto):Promise<number> => {
...
export const  searchIdentityUserLookup = async (input: UserLookupSearchInputDto):Promise<ListResultDto<UserData>> => {
