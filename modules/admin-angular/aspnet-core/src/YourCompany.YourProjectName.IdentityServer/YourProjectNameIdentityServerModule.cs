...
public class YourProjectNameIdentityServerModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                    options.FileSets.ReplaceEmbeddedByPhysical<YourProjectNameDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}YourCompany.YourProjectName.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<YourProjectNameDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}YourCompany.YourProjectName.Domain"));
            });
        }
