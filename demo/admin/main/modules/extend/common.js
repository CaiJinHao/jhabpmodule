...
// api选现
var apiOptions=['https://localhost:6201/api/v1','https://localhost:6201', 'https://localhost:6202/api/v1', 'https://localhost:6202'];
// 接口域
...
layui.config({
    ...
    tableSelect: 'plugins/fake-select/tableSelect',
...
function MyCommon() {
 ...
 function guid() {
 	...
 	var _id = (S4() + S4() + "-" + S4() + "-" + S4() + "-" + S4() + "-" + S4() + S4() + S4());
 	return _id;
 };
